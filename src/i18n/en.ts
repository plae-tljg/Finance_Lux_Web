export const en = {
  ...
  settings: {
    ...
    backupLoaded: 'Backup file loaded - click Restore to apply',
    failedToParse: 'Failed to parse backup file',
    dataRestored: 'Data restored! Reloading...',
    areYouSure: 'Are you sure you want to clear all data? This cannot be undone.',
    currency: 'Currency',
